...
function buildCombatView(width, height){
    ...
    function endCombat(winner){
        ...
        const [winTitle, winMessage, status] = winner.type === Player.type.human? ['Victory!', 'You destroyed the enemy fleet.', 'victory'] : ['Defeat!', 'Your fleet has been sunk.', 'defeat'];
    ...
    return {mount, unmount, showShipAt, setInputActive, updateTurn, updateCell, updateHealth, updateNames, endCombat, on};
}
